...
> The weight of the central bit of each triplet has a step of two, that is, starting from the multiplier LSB (excluding the additional bit '0'): 2^0, 2^2, 2^4, 2^6, 2^8, etc.
